            ...
            <div className="overflow-scroll flex-1">
                <div>
                    {coins?.data?.data?.filter(filter).length !== 0 &&<div>
                        ...
                        <ul>{coins?.data?.data.filter(filter).map((item, index) => {
                                if(index > 5) return;
                                return(
                    ...
                    {searchQuary !== "" && exchanges?.data?.data?.filter(filter).length !== 0 && <div className='mt-4'>
                        ...
                        <ul>{exchanges?.data?.data.filter(filter).map((item, index) => {
                            if(index > 5) return;
                            return(
                                <li key={item.id} className="p-2 px-4 hover:bg-faded-grey cursor-pointer">
                    ...
                    {exchanges?.data?.data?.filter(filter).length === 0 && coins?.data?.data.filter(filter).length === 0 &&
                        <div>
